...
(async ()=>{
  ...
  let exprotResults = await Promise.all([
    exportFrameImages(`${videoPath}/origin.mp4`,`${distOriginPath}/${useFrameCount}-p%04d.jpg`,'100x100',null,originCrop),
    exportFrameImages(`${videoPath}/test.mp4`,`${distTestPath}/p%04d.jpg`,'100x100','eq(n,1)',testCrop)
  ])
